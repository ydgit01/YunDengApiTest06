...
def add(session, key='', type='', name='ss', microserviceCreateType='', modelCreateType='', desc='', viewCreateType='',
	...
	:return:
	'''
	url = host + '/yundeng/microservice/add'
	value = {"key": key, "name": name, "desc": desc, "type": type, "modelCreateType": modelCreateType,
